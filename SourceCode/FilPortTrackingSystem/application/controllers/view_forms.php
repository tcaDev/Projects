...
function haulers(){
 ...
 echo ' <div class="haulers">
			<div class="  con-info consig-pos" data-toggle="collapse" data-target="#haulers"  style="cursor:pointer">
				<span style="cursor:pointer">ADD NEW HAULERS</span>
		</div>
		<div class="haulers consig-posbox collapse" id="haulers">
			<form action="'.base_url('Add_user/add_haulers/').'" method="post">
				<div class="">
		            <div class="form-group col-md-12">
		                <input type="text" name="haulers" class="form-control" placeholder="Hauler Name" required/>
		            </div>
		        </div>
		        <div class="">
		            <div class="form-group col-md-12">
		                <input type="text" name="vesno" class="form-control" placeholder="Hauler No." required/>
		            </div>
		        </div>
		        ';?>
		<script type="text/javascript" src="<?php echo base_url('resources/dropdown/jquery.searchabledropdown-1.0.8.min.js'); ?>"></script>	        
	        <div class="">
	            <div class="form-group  col-md-12 myselect">
	            	<label style="margin-left: 10px;"> Hauler : </label>
	               <select name="haulers" class="form-control">
	            	<?php  foreach($drop as $row){  ?> 
