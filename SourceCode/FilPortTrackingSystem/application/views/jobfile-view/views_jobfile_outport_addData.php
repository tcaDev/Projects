    ...
    <div class="modal-body">
    	<div class="container-fluid">
    		 <ul class="nav nav-pills">
			    ...
			    <li id="btn-truck-outport-add"><a role="button">Description of Goods</a></li>
				  ...
				  <div class="col-lg-12 pill-jobfile-outport-add">
				  	<div class="row">
				  		<div class="col-lg-4" >	
				           ...
				           <input type="hidden" value="2" name="monitoring_type" id="outport"/>
				              ...
				              <!--check if jofile is already exists -->
								 ...
								 <input type="text" class="form-control input-sm jobfiles-outport" name="jbfl" id="jbfl" onkeyup="search_jobfile(this)">
					...
					<div class="col-lg-4">
								...
								<div class="form-group">
								  ...
								  <input type="datetime-local" name="dtRcvd" class="form-control input-sm dtRcvd-outport" >
								</div>

								<div class="form-group">
								  <label for="dtPckup">Date Pick-up / Received O-BL:</label>
								  <input type="datetime-local" name="dt_pickup_obl" class="form-control input-sm dt_pickup_obl-outport" >
								</div>

								<div class="form-group">
								  <label for="dtPckRcv">Date Pick-up / Received Other Document :</label>
								  <input type="datetime-local" name="dt_pickup_docs" class="form-control input-sm dt_pickup_docs-outport" >
								 </div>
								 ...
								 <div class="form-group">
						           ...
						           <div class="form-group">
									   ...
									   <input type="date" name="dt_req_budget" class="form-control input-sm dtReq-outport" id="dtReq">
								  </div>

						         
								<div class="form-group">
									 <label for="rfp">Reference Due Date:</label>
									 <input type="date" name="ref_due_dt" class="form-control input-sm rfp-outport" id="rfp">
								 </div>
							...
							<div class="col-lg-4" >
								...
								<div class="form-group">
									...
									<select name="color-select" id="color-select" class="form-control input-sm color-select-outport">
...
<!-- 						<div class="form-group">
				  	...
				  	<div id="tableAddContainer-outport" class="hidden pill-container-outport-add table-editable ">
					  	...
					  	<div class="col-lg-6">
							...
							<div class="form-group">
								...
								<input type="text" step="1" class="form-control input-sm cartons-outport" id="cartons" name="numofcartons">
							</div>
					  	...
					  	<div class="form-group">
							...
							<div class="form-group">
								<label>Haulers</label>
								<input type="datetime-local" name="gtinport" class="form-control input-sm haulers-outport" />
							</div>

							<div class="form-group">
								<label>Actual P-Out Date of Container</label>
								<input type="datetime-local" name="gtoutport" class="form-control input-sm act-p-dt-cont-outport" />
							</div>

							<div class="form-group">
								<label>Actual Date Received Container to  Warehouse</label>
								<input type="datetime-local" name="act-del-whse" class="form-control input-sm act-dt-rcvd-cont-whse-outport" />
							</div>
 ...
 <!--     <button type="button" class="btn btn-danger container_insert">test insert</button> -->
      <button type="button" class="btn btn-danger btn-Next-outport">Next</button>
...
<script>
	...
	/*$(document).ready(function(){
		 ...
		 $('#btn-container-outport-add').attr('disabled', 'disabled');
   ...
   /* $(".deleteButton").click(function(){
	...
	$(document).ready(function(){
		...
		$(".btn-Add-Container-Data-outport").click(function(){
			...
			else if($('#tableAddContainer-outport .carrier-outport').val() == "0")
			{
	       ...
	       /* $('#tableAddContainer-outport table tr:last td:nth-child(2)').html($(".containerss option:selected").text());*/
	        $('#tableAddContainer-outport table tr:last td:nth-child(3)').html($(".carrier-outport").val()).hide();
	        $('#tableAddContainer-outport table tr:last td:nth-child(4)').html($(".carrier-outport option:selected").text());
	        $('#tableAddContainer-outport table tr:last td:nth-child(5)').html($(".vessel-outport").val());
	        $('#tableAddContainer-outport table tr:last td:nth-child(6)').html($(".cartons-outport").val());
	            ...
	            $('#tableAddContainer-outport table tr:last td:nth-child(8)').html($(".est-arr-outport").val());
	             $('#tableAddContainer-outport table tr:last td:nth-child(9)').html($(".act-arr-outport").val());
	              $('#tableAddContainer-outport table tr:last td:nth-child(10)').html($(".storage-outport").val());
	               $('#tableAddContainer-outport table tr:last td:nth-child(11)').html($(".demorage-outport").val());
	                $('#tableAddContainer-outport table tr:last td:nth-child(12)').html($(".lodging-outport").val());
	                 $('#tableAddContainer-outport table tr:last td:nth-child(13)').html($(".trgtdeldt-outport").val());
	                  $('#tableAddContainer-outport table tr:last td:nth-child(14)').html($(".haulers-outport").val());
	                   $('#tableAddContainer-outport table tr:last td:nth-child(15)').html($(".act-p-dt-cont-outport").val());
	                    $('#tableAddContainer-outport table tr:last td:nth-child(16)').html($(".act-dt-rcvd-cont-whse-outport").val());
	                     $('#tableAddContainer-outport table tr:last td:nth-child(17)').html($(".dt_boc-outport").val());
			...
			$('.vessel-vessel-msg-outport').text('');
			...
			$('#tableAddContainer-outport .vessel-outport').val('');
			...
			$('#tableAddContainer-outport .haulers-outport').val('');
			$('#tableAddContainer-outport .act-p-dt-cont-outport').val('');
			$('#tableAddContainer-outport .act-dt-rcvd-cont-whse-outport').val('');
		...
		$(".btn-Add-Product-Data-outport").click(function(){
			...
			var cont = $('#tableAddTruck-outport .containers-prod option:selected').val();
			var prod = $('#tableAddTruck-outport .prodname option:selected').val();
			...
			$('#tableAddTruck-outport .origincity').val('');
