						...
						<div class="col-lg-6">
							...
							<div class="form-group">
							 ...
							 <div class="form-group">
								 	...
								 	<input type="datetime-local" name="es_dep_time" class="form-control input-sm edt-updateVessel-outport">
						     </div>

						     <div class="form-group">
								<label>Estimated Arrival Time</label>
								<input type="datetime-local" name="est-dept" class="form-control input-sm eat-updateVessel-outport" />
							 </div>
