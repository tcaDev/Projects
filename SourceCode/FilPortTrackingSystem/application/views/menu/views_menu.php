		...
		<div class="menu-container">
				<div class="row">
						<!-- Job File -->
					<a style="display:block" href="<?php echo base_url('Login_user/jobfile')?>">	
					<div class="menu-tiles effect__hover">
						...
						<!-- Client Management -->
						<a style="display:block" href="<?php echo base_url('Login_user/settings')?>">
					<div class="menu-tiles effect__hover">
						<div class="col-lg-4 col-md-4 col-sm-4  btn btn-clnt-mngt card__front" style="box-shadow: 0 2px 2px -2px rgba(0, 0, 0, .52);">
							<div class="row">
								...
								<div class="col-lg-8 col-md-8 col-sm-8">
									<span class="client-mngt">Site<br>Settings</span>
								</div>
					...
					<div class="menu-tiles effect__hover">
						<div class="col-lg-4 col-md-4 col-sm-4  btn btn-gbl card__front" style="box-shadow: 0 2px 2px -2px rgba(0, 0, 0, .52);">
							<div class="row">
								...
								<div class="col-lg-8 col-md-8 col-sm-8">
									<span class="gbl-srch">Global<br> Search</span>
								</div>
