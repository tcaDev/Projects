    	...
    	<div class="col-md-12 ">
        	...
        	<div class="col-md-12" style="margin-top:10px;">
				...
				<ul class="nav nav-tabs">
				    <li class="active"><a data-toggle="tab" href="#pi-admin">Search By Proforma Invoice No.</a></li>
				       ...
				       <div class="col-md-12">
					       	<div class="col-md-5">
							    <div class="input-group">
							      <input type="text" class="form-control light-table-filter input-sm" id="txt-table-runningcharges-admin-po" placeholder='Enter Proforma Invoice Number..'>
                ...
                <div class="modal-body">
                   <div class="col-md-12">
                    ...
                    <div class="col-md-4" style="padding-top:15px;"> 
                      <a href='#' id="running_charges_csv"><input type="button" class="btn btn-success btn-save-as-running_charges form-control" value="CSV File"/></a>
                    </div>
                    <div class="col-md-4" style="padding-top:15px;">
                      <a href='#' id="running_charges_pdf"><input type="button" class="btn btn-danger btn-save-as-running_charges form-control" value="PDF File"/></a>
                     </div>
                   </div>
                </div>
               </div>
